...
public class TestImport {
	...
	public void testImport()throws RemoteException{
		...
		assertEquals((new InventoryVO(1, 1, 1, 1,"full")).getA(),(test.addPlace()).getA());
		assertEquals((new InventoryVO(1, 1, 1, 1,"full")).getB(),(test.addPlace()).getB());
		assertEquals((new InventoryVO(1, 1, 1, 1,"full")).getC(),(test.addPlace()).getC());
		assertEquals((new InventoryVO(1, 1, 1, 1,"full")).getD(),(test.addPlace()).getD());
