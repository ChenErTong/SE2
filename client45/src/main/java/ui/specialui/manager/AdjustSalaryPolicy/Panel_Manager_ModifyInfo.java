...
public class Panel_Manager_ModifyInfo extends MyTranslucentPanel{

	
	public Panel_Manager_ModifyInfo() {
	...
	private void initComponent() {
		...
		MyJLabel title = new MyJLabel(195,10,170,40, "修改策略信息", 24, true);
		this.add(title);
		
		MyJLabel  policyName = new MyJLabel(20, 60, 100, 30, "策略名称", 18, true);
		this.add(policyName);
