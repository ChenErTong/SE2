...
public class TrainCommodity extends MyJPanel {
	...
	public TrainCommodity(Frame_Transfer frame) {
		...
		orderSelected.addMouseListener(new MouseAdapter() {
			public void mouseMoved(MouseEvent e) {
				...
				MyEmptyTextArea orderInfo = new MyEmptyTextArea(e.getX(), e
						.getY(), 150, 250);
		...
		MyButton TransferOrder = new MyButton(584, 600, 111, 33,
				TransferImage.getBUTTON_ZHUANGCHEDAN());
	...
	private void setOrdersID() {
		BranchBLService branchController = ControllerFactory
				.getBranchController();
