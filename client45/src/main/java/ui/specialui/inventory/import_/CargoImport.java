...
public class CargoImport extends MyJPanel {
	...
	public CargoImport(Frame_Inventory frame) {
		...
		MyJButton produceArrivalList = new MyJButton(580, 600, 120, 30, "生成装车单", 20);
		produceArrivalList.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(CargoImport.this.produceArrivalList()){
