...
public class OpeningStockController implements OpeningStockBLService {
	...
	@Override
	public ResultMessage add(ArrayList<TransferVO> commodities, ArrayList<BranchVO> clients0,
			ArrayList<AccountVO> clients1, ArrayList<FacilityVO> clients2, ArrayList<InventoryVO> clients3,
