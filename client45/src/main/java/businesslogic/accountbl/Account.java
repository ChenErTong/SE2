...
/**
 * 存取account信息
 * 通过BranchInfo和TransferInfo改变响应机构中人员的信息
 * 
 * @author LIUXUANLIN
 * @author Ann
...
public class Account{
	 ...
	 * @param organizationID String型，机构编号
	 * @param accountID String型，人员编号
	 * @return 是否删除成功
	 * @throws RemoteException 远程异常
	 */
	 ...
	 * @param account AccountPO型，新人员信息
	 * @return 是否修改成功
	 * @throws RemoteException 远程异常
	 */
	private ResultMessage modifyAccountInOrganization(AccountPO account) throws RemoteException {
		String organizationID = account.getOrganizationID();
		if(organizationID.length()==4){
			//The organization is transfer,use transferInfo to modify this account
