package bussinesslogicservice_stub.inventoryblservice;
...
public class InventoryBLService_Stub implements InventoryBLService{
	...
	private static final String commoditiesID = null;
	private static final String destination = null;
	private static final String transferID = null;
	/** 出库数量 **/
	...
	public InventoryViewVO viewInventory(String beginDate, String endDate) {
		...
		return new InventoryViewVO( exportNumber,  importNumber,  a);
	}
    @Override
	public InventoryCheckVO checkRecord() {
		// TODO Auto-generated method stub
		return new InventoryCheckVO(null, adjustID);
	}
